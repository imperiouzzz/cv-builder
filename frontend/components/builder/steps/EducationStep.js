...
export default function EducationStep() {
  ...
  function updateEntry(id, key, value) {
    setCVField(
      "education",
      cv.education.map((e) => (e.id === id ? { ...e, [key]: value } : e)),
    );
  }
  ...
  return (
    <>
      ...
      <TipBox>
        💡 Include GPA only if it&apos;s 3.0+ or First/Second Class. Add
            ...
            <Grid>
              <Field label="Degree & Major" required>
                <Input
                  ...
                  value={e.degree}
                  onChange={(ev) =>
                    updateEntry(e.id, "degree", ev.target.value)
                  }
                />
              </Field>
              <Field label="Institution" required>
                <Input
                  ...
                  value={e.institution}
                  onChange={(ev) =>
                    updateEntry(e.id, "institution", ev.target.value)
                  }
                />
              </Field>
            </Grid>
            <Grid cols={3}>
              <Field label="Location">
                <Input
                  ...
                  value={e.location}
                  onChange={(ev) =>
                    updateEntry(e.id, "location", ev.target.value)
                  }
                />
              </Field>
              <Field label="Start Date">
                <Input
                  ...
                  value={e.startDate}
                  onChange={(ev) =>
                    updateEntry(e.id, "startDate", ev.target.value)
                  }
                />
              </Field>
              <Field label="End Date">
                <Input
                  ...
                  value={e.endDate}
                  onChange={(ev) =>
                    updateEntry(e.id, "endDate", ev.target.value)
                  }
                />
              </Field>
            </Grid>
            <Grid>
              ...
              <Field label="Achievements / Coursework">
                <Input
                  ...
                  onChange={(ev) =>
                    updateEntry(e.id, "achievements", ev.target.value)
                  }
                />
              </Field>
            </Grid>
