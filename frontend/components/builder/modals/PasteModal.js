...
export default function PasteModal({ onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Open your existing CV, select all (Ctrl+A), copy (Ctrl+C), then paste
          below. The parser will detect and fill your name, contact info,
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                {filled.length > 0 ? (
                  ...
                  <p style={{ fontSize: 12, color: "#718096" }}>
                    Nothing was auto-detected. Check that the text includes
                    section headings like EDUCATION, WORK EXPERIENCE, SKILLS.
                  </p>
                )}
              </div>
              <p style={{ fontSize: 11, color: "#718096", marginTop: 10 }}>
                Review each section and edit any fields the parser may have
                missed.
              </p>
            </div>
